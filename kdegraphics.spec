...
Summary(pt_BR):	K Desktop Environment - AplicaÁıes gr·ficas
Name:		kdegraphics
Version:	2.2.2
Release:	2
Epoch:		7
...
Pakiet zawiera:
- KDVI - Przegl±darka plikÛw DVI,
- KFax - Program do wy∂wietlania faksÛw,
...
- KView - Przegl±darka plikÛw graficznych.

%description -l pt_BR
AplicaÁıes gr·ficas para o KDE.
...
Arquivos de inclus„o para compilaÁ„o de aplicaÁıes que usem as
...
Program do przegl±dania plikÛw DVI.

%description -l pt_BR kdvi
Programa de exibiÁ„o de DVIs.
...
Program ten umoøliwia przegl±danie plikÛw faksowych (G3)

%description -l pt_BR kfax
Programa de visualizaÁ„o de faxes (formato TIFF).
...
Program ten umoøliwia przegl±danie plikÛw postscriptowych (.ps)

%description -l pt_BR kghostview
Programa de visualizaÁ„o de arquivos Postscript e PDF.
...
Editor de Ìcones, lida inclusive com arquivos .ICO.
...
%description -l pl kfax
Program ten umoøliwia ogl±danie rÛønych plikÛw graficznych (G3).
...
NarzÍdzie do skanowania.

%description -l pt_BR kooka
Um programa de rasterizaÁ„o de imagens, baseado no SANE e libkscan.
